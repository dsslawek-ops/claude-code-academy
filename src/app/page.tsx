  ...
  return (
    <AppShell>
      ...
      <button
        ...
        className="mb-16 flex w-full items-center gap-3 rounded-lg border border-border px-4 py-3 text-left text-xs text-muted-foreground transition-colors hover:border-muted-foreground/25"
      >
      ...
      <div className="mb-16 grid gap-px overflow-hidden rounded-lg border border-border sm:grid-cols-3">
        ...
        >
          ...
          <p className="text-xs font-medium">Szkolenia</p>
        ...
        >
          ...
          <p className="text-xs font-medium">Ściągawka</p>
          <p className="text-xs leading-relaxed text-muted-foreground">
        ...
        >
          ...
          <p className="text-xs font-medium">Rozwiąż problem</p>
          <p className="text-xs leading-relaxed text-muted-foreground">
